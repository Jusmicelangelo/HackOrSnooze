...
class StoryList {
  ...
  static async getStories() {
    ...
    //  instance method? Because it should be the SAME for every new getStories Object 
  ...
  async removeStory(user, storyId) {
    ...
    // ID we are removing in all stories
...
class User {
  ...
  /** handling favorite/not-favorite.
  ...
  /** New favorite and update the API
  ...
  /** Remove as favorite and update the API
  ...
  async removeFavorite(story) {
   ...
   /** checks whether the choosen Story is a favorite */
